# Action Series Assignments
### *Package Name*: action-series-assignments
...
```
npm install action-series-assignments
```
...
This module uses the assignments "template" and runs an asynchronous forEach on each assignment. The template provides methods and data used to complete the action-series model.
